...
py -m producers.kafka_producer_hansen
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.kafka_producer_hansen
```
...
```shell
.venv\Scripts\activate
py -m consumers.kafka_consumer_hansen
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.kafka_consumer_hansen
```
